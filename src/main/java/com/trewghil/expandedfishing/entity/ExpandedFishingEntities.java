...
public class ExpandedFishingEntities {
    ...
    public static final EntityType<QuipperEntity> QUIPPER_ENTITY = FabricEntityTypeBuilder.<QuipperEntity>create(SpawnGroup.WATER_AMBIENT, QuipperEntity::new).dimensions(EntityDimensions.fixed(0.5F, 0.5F)).build();
    ...
    public static void init() {
        ...
        FabricDefaultAttributeRegistry.register(QUIPPER_ENTITY, QuipperEntity.createMobAttributes()
                ...
                .add(EntityAttributes.GENERIC_MOVEMENT_SPEED, 0.95D)
